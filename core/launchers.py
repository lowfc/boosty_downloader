...
from boosty.api import get_all_image_media, get_all_video_media, get_all_posts
...
async def get_file_and_raise_stat(url: str, path_file: Path, tracker: StatTracker, _t: Literal["p", "v"]):
