...
class MergeAuthorContentPage(ft.View):
    def __init__(self, manager: DownloadManager):
        ...
        self.action_type = ft.Dropdown(
            ...
            label="Action",
            value="copy",
            options=[ft.DropdownOption(key="copy", text="Copy"), ft.DropdownOption(key="move", text="Move")]
        )
        ...
        self.controls = [
            ...
            ft.Row([
                ft.Column([
                        ft.Text("Transfer content from the author's post folders to one folder"),
                        self.action_type,
    ...
    async def do_merge(self):
        source_folder = Path(self.settings.downloads_folder) / self.authors_dropdown.value
        ...
        photo_extensions = {'.jpg', '.jpeg', '.png', '.gif', '.bmp', '.tiff', '.webp', '.heic', '.raw'}
